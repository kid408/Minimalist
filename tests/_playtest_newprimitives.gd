...
func _initialize() -> void:
	...
	if arena == null or not is_instance_valid(arena):
		print("NECPRIM_FAIL: no arena"); quit(); return
	...
	if enemy == null or not is_instance_valid(enemy):
		print("NECPRIM_FAIL: no enemy"); quit(); return
	...
	print("buff_stat damage_pct=%.2f" % player.temp_buff_mult("damage_pct"))
	...
	print("reflect_ratio=%.2f" % player.reflect_ratio)
